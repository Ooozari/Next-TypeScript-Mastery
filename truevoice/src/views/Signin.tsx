      ...
      <div className="w-full max-w-md p-6 md:p-8 space-y-8 bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl border border-teal-300/50 animate-fade-in container mx-auto">
        ...
        <Form {...signInForm}>
          ...
          >
            ...
            />
            <div className="text-center">
              <Paragraph size="normal" className="text-teal-100">
                Forgot your password?{" "}
                <Link
                  href="/forgot-password"
                  className="text-teal-300 font-medium hover:text-white underline-offset-4 hover:underline transition-colors duration-300"
                >
                  Reset Password
                </Link>
              </Paragraph>
        ...
        <div className="text-center">
          <Paragraph size="large" className="text-teal-100">
            {" "}
